...
def load_and_predict(currency):
    df = pd.read_csv(f"./dataset/{currency}.csv")
    ...
    model = load_model(f"./model/{currency}.h5")
...
rp_btc, valid_btc, lastest_btc = load_and_predict(currencies[0])
rp_eth, valid_eth, lastest_eth = load_and_predict(currencies[1])
rp_ada, valid_ada, lastest_ada = load_and_predict(currencies[2])
                    ...
                    children=[
                        html.Div(
                            [
                                ...
                                html.H3(
                                    f"Price prediction for tomorrow: {lastest_btc[0][0]:.2f} USD",
                                    style={"textAlign": "center"},
                                ),
                                dcc.Graph(
                                    id="Actual Data BTC",
                    ...
                    children=[
                        html.Div(
                            [
                                ...
                                html.H3(
                                    f"Price prediction for tomorrow: {lastest_eth[0][0]:.2f} USD",
                                    style={"textAlign": "center"},
                                ),
                                dcc.Graph(
                                    id="Actual Data ETH",
                    ...
                    children=[
                        html.Div(
                            [
                                ...
                                html.H3(
                                    f"Price prediction for tomorrow: {lastest_ada[0][0]:.2f} USD",
                                    style={"textAlign": "center"},
                                ),
                                dcc.Graph(
                                    id="Actual Data ADA",
